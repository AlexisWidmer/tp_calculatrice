...
/// \sa soustraction(int64_t, int64_t), soustraction(float, float), soustraction(double, double).
///
...
/// \sa soustraction(int32_t, int32_t), soustraction(float, float), soustraction(double, double).
///
...
/// \sa soustraction(int32_t, int32_t), soustraction(int64_t, int64_t), soustraction(double, double).
///
...
/// \sa soustraction(int32_t, int32_t), soustraction(int64_t, int64_t), soustraction(float, float).
///
