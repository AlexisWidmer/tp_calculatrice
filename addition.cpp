...
/// \sa addition(int64_t, int64_t), addition(float, float), addition(double, double).
///
...
/// \sa addition(int32_t, int32_t), addition(float, float), addition(double, double).
///
...
/// \sa addition(int32_t, int32_t), addition(int64_t, int64_t), addition(double, double).
///
...
/// \sa addition(int32_t, int32_t), addition(ibnt64_t, int64_t), addition(float, float).
///
