...
/// \sa multiplication(int64_t oppA. int64_t oppB). multiplication(float oppA. float oppB). multiplication(double oppA. double oppB).
///
...
/// \sa multiplication(int32_t oppA. int32_t oppB). multiplication(float oppA. float oppB). multiplication(double oppA. double oppB).
///
...
/// \sa multiplication(int32_t oppA. int32_t oppB). multiplication(int64_t oppA. int64_t oppB). multiplication(double oppA. double oppB).
///
...
/// \sa multiplication(int32_t oppA. int32_t oppB). multiplication(int64_t oppA. int64_t oppB). multiplication(float oppA. float oppB).
///
